...
def mean(x,y,ref_units,rk=7,dx=60.):
    ...
    te = cdtime.comptime(t1c.year, t1c.month, t1c.day).add(1, cdtime.Day).torel(units).value
    X = x - float(t0)
...
def get_history(year,month,day,station_id=None,session=None,key="606f3f6977348613",loggly="25e68a9b-b928-4129-b536-cc3112ee71c3"):
    ...
    url = "https://api-ak.wunderground.com/api/%s/history_%s/units:english/v:2.0/q/pws:%s.json" % (key,date, station_id)
    if session is None:
